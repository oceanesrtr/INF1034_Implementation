...
Classe Controller de l'interface propriétaire : gère les performances
d'un restaurant*/

public class ControllerPerformance implements Initializable {
    ...
    @FXML
    public Button boutonPerformance;
    ...
    * ========================================================================*/
    ...
    public void initialize(URL location, ResourceBundle resource) {
        //[b] redirection vers des actions ou pages
